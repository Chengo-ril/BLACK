...
if (isset($_REQUEST['cat'])){
    $sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as newDate FROM videotable WHERE category='$_REQUEST[cat]'";
...
<head>
	<title>ECTASY | VIDEO CATEGORY</title>
					...
					<div class="col-sm-8">
						...
						<div class="block-content">
							...
							<div class="grid-box">
                                ...
                                <?php
						$sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as newDate FROM videotable  WHERE category='$_REQUEST[cat]'";
						$sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as newDate FROM `videotable` WHERE category='$_REQUEST[cat]' ORDER BY `id` DESC LIMIT 70";
									...
									<div class="col-md-6">
										<div class="news-post standard-post2">
											...
											<h2><a <?php echo "href='news.php?a=".$row['a']."'"?>><?php echo $row['headline']; ?></a></h2>
												<ul class="post-tags">
													<li><i class="fa fa-eye"></i><?php echo $row['newDate']; ?></li>
