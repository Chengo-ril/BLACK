...
<body class="boxed">
						...
						<div class="block-content">
							...
							<div class="grid-box">
								<div class="title-section">
									...
									<h1><span class="world">Search Results</span></h1>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM `blogtable` WHERE `headline` LIKE '%".$search."%' OR category = '$search'";
                                    $result = mysqli_query($conn, $sql);
    ...
    echo "<script>alert('Oops! News not found')
