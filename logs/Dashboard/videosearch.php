...
<head>
    ...
    <title>Ectasy | Video Search</title>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Video Report by Category</h5>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    if ($_POST) {
                                        ...
                                        $sql = "SELECT *, DATE_FORMAT(date, '%a-%d-%b-%Y') as newDate FROM `videotable` WHERE `category`='$category' AND `date` BETWEEN '$datefrom' AND '$dateto'";
...
>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <li><a <?php echo "href='editvideo.php?id=".$row['id']."'";?> 
                                            onclick="return confirm('Are you sure to edit the video');">Edit</a></li>
                                            <li><a <?php echo "href='deletevideo.php?id=".$row['id']."'";?> 
                                            onclick="return confirm('Are you sure to delete video');">Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
